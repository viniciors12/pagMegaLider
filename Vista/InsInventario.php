  ...
  <head>
    ...
    $(document).ready(function(){
          $("#enviar").click(function(){
            ...
            var cod = $("#codigo").val()
            var codEmp = $("#cedula").val()
            var date = $("#fecharegistro").val()
            var codP = $("#codigoP").val()
            var cant = $("#cantidad").val()

          
                $.post("InsertarInventario.php",{codIn:cod,codEmpInv:codEmp,codPInv:codigoP,cantidadInv:cant},function(datos){
      ...
      <header>
       ...
       <section class="mainIns"> 
        ...
        <div id="formEmpleado">
          ...
          <input type="TEXT" name="codigoIn" class="form-control" id="codigo">
        </div>
        <div class="form-group">
          <label for="cedulaP">Cédula de empleado:</label>
          <input type="TEXT" name="cedulaInv" class="form-control" id="cedula">
        </div>
        <div class="form-group">
          <label for="fecharegistro">Fecha de registro:</label>
          <input type="DATE" name="fregistroInv" class="form-control" id="fecharegistro">
        </div>
        <div class="form-group">
          <label for="codigo">Código del producto:</label>
          <input type="TEXT" name="codigoC" class="form-control" id="codigoP">
        </div>
        <div class="form-group">
          <label for="cantidad">Cantidad:</label>
          <input type="TEXT" name=cantidadF class="form-control" id="cantidad">
        </div>
        <button type="submit" id="enviar" name="contraEm" class="btn btn-primary">Agregar</button>
