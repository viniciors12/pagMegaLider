  ...
  <head>
    ...
    $(document).ready(function(){
          $("#enviar").click(function(){
            ...
            var cod1 = $("#codigoF").val()
            var cod2 = $("#codigoP").val()

          
                $.post("consultaGarantias.php",{codigoFac:cod1,codigoPro:cod2},function(datos){
      ...
      <header>
       ...
       <section class="mainIns"> 
        ...
        <div id="formEmpleado">
          ...
          <input type="TEXT" name="codigo" class="form-control" id="codigoF">
        </div>
        <div class="form-group">
          <label for="codigo">Código del producto:</label>
          <input type="TEXT" name="codigo" class="form-control" id="codigoP">
        </div>
